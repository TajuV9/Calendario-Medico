      ...
      <div className="card p-4" style={{ maxWidth: "400px", width: "100%" }}>
        ...
        <form onSubmit={onSubmitHandler}>
          <div className="mb-3">
            ...
            <input type="text" id="name" className="form-control" placeholder={t('enter_name')} required
              value={name} onChange={(e) => setName(e.target.value)} />
          </div>

          <div className="mb-3">
            <label htmlFor="email" className="form-label">{t('email')}</label>
            <input type="text" id="email" className="form-control" placeholder={t('enter_email')} required
              value={email} onChange={(e) => setEmail(e.target.value)} />
          </div>

          <div className="mb-3">
            <label htmlFor="password" className="form-label">{t('password')}</label>
            <input type="password" id="password" className="form-control" placeholder={t('enter_password')} required
          ...
          <div className="text-center my-3">
            <p>
              ...
              <Link to="/login" className="text-decoration-underline">{t('login_here')}</Link>
            </p>
          </div>
        </form>
      </div>
